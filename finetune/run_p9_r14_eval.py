"""Phase 9 R14 — Evaluate r19 (full train data 433k) leak-free on panel.

R13 confirmed inference-side exhausted. R14 tests training-side: full train
data (433k vs r5's 100k/epoch). More samples per epoch may find a better
optimum for the randomly-initialized frozen head.

Output: outputs/eval_p9_panel_r14_fulltrain.json
"""
...
TEST_LO = "2025-12-15"
COST = 0.0005
MODELS = ["r5_frozen_pool48", "r19_frozen_fulltrain"]
IDX_N = 5
...
def main():
    ...
    out_path = ROOT / "outputs" / "eval_p9_panel_r14_fulltrain.json"
