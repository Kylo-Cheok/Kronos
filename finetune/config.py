...
class Config:
    ...
    def __init__(self):
        ...
        self.forecast_pool_size = 16
        self.forecast_head_dropout = 0.1
        self.return_loss_weight = 1.0
        self.direction_loss_weight = 0.25
        self.direction_min_deadzone = 0.003
        self.direction_volatility_multiplier = 0.5
        ...
        self.predictor_save_folder_name = 'a_share_multihorizon_predictor'
