"""Phase 9 R16 — Evaluate r21 (hinge swap penalty) leak-free on panel.

R15 raw P(opposite) caused FLAT collapse. R16 uses hinge form
relu(P(opposite) - P(correct)) which doesn't incentivise FLAT.
r21 config = r5 + swap_penalty_weight=1.0 (hinge form).

Output: outputs/eval_p9_panel_r16_swaphinge.json
"""
...
TEST_LO = "2025-12-15"
COST = 0.0005
MODELS = ["r5_frozen_pool48", "r21_frozen_swaphinge"]
IDX_N = 5
...
def main():
    ...
    out_path = ROOT / "outputs" / "eval_p9_panel_r16_swaphinge.json"
